...
print('Comments "push":')
## /n - перевод строки
print("git push <remote> <branch> - публикация указанной ветки в удаленном репозитории вместе со всеми необходимыми коммитами и внутренними объектами")
print("Задаем репозиторий: git remote add origin https://github.com/Название_проекта")
print("Заливай в репозиторий: git push -f origin main")
print("git push <remote> --force - Принудительная публикация указанной ветки в удаленном репозитории")
print("git push -f origin main - принудительное выполнение публикации")
print("git push <remote> --all - публикация всех локальных веток в указанном удаленном репозитории")
